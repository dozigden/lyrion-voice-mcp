        ...
        new(
            ...
            candidates
                ...
                .Select(candidate => new SearchPlaylist(
                    ...
                    candidate.Reference))
                .ToArray(),
            Providers.BbcSounds.BbcSoundsSearchMapper.MapSubscriptions(candidates),
            Providers.BbcSounds.BbcSoundsSearchMapper.MapStations(candidates));
