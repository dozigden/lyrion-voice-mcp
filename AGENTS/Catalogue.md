...
- Catalogue data is rebuilt from LMS when the EF schema replaces the legacy catalogue; never import, delete, or rewrite the legacy catalogue database automatically. EF schema changes use generated application-database migrations.
