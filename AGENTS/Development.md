...
- The EF application database, read-only legacy observation import source, transitional canonical catalogue database, transitional operational database, and disposable production search index live under `/data`; keep that path on a persistent volume.
